...
# PorterStemmer object for stemming words
stemmer = PorterStemmer()

# iterate over words and applying stemming
for i in range(len(sentences)):
    # create a word list out of each sentence
    words = nltk.word_tokenize(sentences[i])
    # list comprehension of stemmed words
    newWords = [stemmer.stem(word) for word in words]
    # replace sentences values with stemmed versions
