...
# creates 2 dimensional array of tuples with words and their parts of speech
tagged_words = nltk.pos_tag(words)

# iterate over tagged_words merge tuples of words and parts of speech and append into word_tags
word_tags = []
